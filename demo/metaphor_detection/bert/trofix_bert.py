...
with open('../data/TroFi-X/TroFi-X_formatted_svo.csv', encoding='latin-1') as f:
    ...
    for line in lines:
        ...
        raw_train_vua.append([line[3], label_seq])


# sen_ix, label_seq, pos_seq
# TODO pos_seq 是否要用于训练
# FIXME 
tr_sentences = [r[0] for r in raw_train_vua[:1300]]
val_sentences = [r[0] for r in raw_train_vua[1300:]]

tr_labels = [r[1] for r in raw_train_vua[:1300]]
val_labels = [r[1] for r in raw_train_vua[1300:]]
